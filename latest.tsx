...
// Horizontal Testimonials Component
        ...
        <div className="sticky top-0 h-screen flex items-center overflow-hidden">
          <motion.div style={{ x }} className="flex gap-8 px-6">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                className="relative flex-shrink-0 w-full max-w-lg"
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -top-12 left-0 text-[200px] font-serif text-accent pointer-events-none"
                >
                  "
                </motion.div>
                ...
                <div className="grid grid-cols-1 gap-8 items-center h-full">
                  ...
                  <motion.div
                    ...
                    className="relative p-8 md:p-12 rounded-3xl border border-white/10 backdrop-blur-xl h-full flex flex-col justify-center"
                    style={{
